...
parser.add_argument('--root_path', type=str, default='/home/cyagen/tyler/CTM/UA-MT/data/CTM_dataset/Segmented')
    ...
    for epoch_num in tqdm(range(max_epoch), ncols=70):
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            for i in range(num_classes):
                loss_mid = losses.dice_loss(outputs_soft[:labeled_bs, i, :, :, :], label_batch[:labeled_bs] == i)
                loss_seg_dice += cls_weights[i]*loss_mid
            ...
            consistency_dist = consistency_criterion(outputs[labeled_bs:], ema_output) #(batch, num_classes, 112,112,80)
